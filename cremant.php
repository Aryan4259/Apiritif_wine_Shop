...
<head>
    ...
    <title>Cremant de bordeaux</title>
    <style>
        *{
        padding: 0;
        margin: 0;
...
<body>
<form method="POST" action="cremant.php">
    <!--header1 section-->
    ...
    <section class="shop">
        ...
        <div class="detail">
            <div class="dtl1"><h2>Cremant de bordeaux</h2></div>
            <div class="dtl2"><h5>60$</h5></div>
            <div class="dtl3"><p>A traditional method sparkling with flavours of apples and brioche.
            Best enjoyed chilled within 2 years of purchase.<br><br>
            Crémant de Bordeaux is one of eight French crémants
            (French for “creamy”) that are made using traditional
            fermentation methods in a very similar fashion to Champagne.
            All the grapes used in a sparkling wine must be picked by hand
            and the wine aged for a minimum of twelve months to qualify as Crémant de Bordeaux.</p></div>
