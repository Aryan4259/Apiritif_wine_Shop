...
<form method="POST" action="forgot.php">
    ...
    <section class="forgot" id="forgot">
        ...
        <div class="log-form">
            <div class="ip1-mobile"><p>New Password : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></div>
            <div class="ip2-mobile"><input type="password" name="psw1"></div>
        </div>
        <div class="log-form">
            <div class="ip1-mobile"><p>Confirm Password : </p></div>
            <div class="ip2-mobile"><input type="password" name="psw2"></div>
        </div>
        <div class="log-form-btn">
            <div class="submit_1"><a href="login.php"><p><input class="submit_in" type="submit" name="update" value="Update"></p></a></div>
        </div>
    </section>
    ...
    if($qry)
    {
        while ($row = mysqli_fetch_array($qry))
        {
            ...
            if($m_no==$m_no1)
            {
                if($psw1==$psw2)
                {
                    $update="UPDATE user SET psw='$psw1' WHERE m_no='$m_no1'";
