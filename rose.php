...
<form method="POST" action="rose.php">
    ...
    <section class="shop">
        ...
        <div class="detail">
            <div class="dtl1"><h2>Nyetimber Rose</h2></div>
            <div class="dtl2"><h5>65$</h5></div>
            <div class="dtl3"><p>DISCOVER OUR PASSION FOR SPARKLING ROSÉ
            A textured and generous rosé with a core of bright red fruit, evoking the English summer. This beautiful sunset-pink Multi-Vintage rosé has us dreaming of long, sunny days. Offering a unique combination of aromas, including British summer fruits and shortbread. Its creamy, round texture and refreshing redcurrant, raspberry and cherry flavours give it an elegant and silky finish.</p></div>
