...
<body>
<form method="POST" action="prosecco.php">
    <!--header1 section-->
    ...
    <section class="shop">
        <div class="img_1">
            <img src="prosecco.jpg">
        </div>

        <div class="detail">
            <div class="dtl1"><h2>Prosecco ITALIA</h2></div>
            <div class="dtl2"><h5>70$</h5></div>
            <div class="dtl3"><p>Most prosecco is extra dry or brut, styles which have discernible sweetness. Champagne tends to be drier, with extra brut being a more common level of dosage. Those looking for bone dry wine should try brut nature (zero dosage) Champagne.<br><br>
            Prosecco is made from at least 85% glera, which is a fruity, aromatic white grape. Other grapes are allowed in smaller quantities, including chardonnay and pinot noir, two of the main grapes of Champagne. Champagne is based on these two grapes, plus the red grape pinot meunier, and does not include glera.</p></div>
...
<script src="prosecco1.js"></script>
</body>
</html>